    ...
    <div>
        <div className='shadow-md'>
            ...
            <div className='p-4 rounded-b-md'>
                ...
                <Link className='text-white cursor-pointer inline-block bg-[#ff7e01] border-0 font-medium text-center px-7 mt-4 py-2 rounded-md hover:bg-black hover:text-white duration-500'>Read More</Link>
            </div>
        </div>
    </div>
  )
